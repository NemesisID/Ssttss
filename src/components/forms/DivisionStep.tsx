...
const DIVISIONS = [
  { value: "PROGRAMMING", label: "Programming", desc: "Belajar membuat program, database, dan aplikasi web dari awal.", icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" },
  { value: "DATA", label: "Data", desc: "Belajar mengolah, menganalisis, dan membaca data untuk mengambil kesimpulan", icon: "M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4" },
  { value: "BUSINESS_PLAN", label: "Business Plan", desc: "Mempelajari validasi masalah, Business Model Canvas, riset pasar, hingga penyusunan pitch-deck.", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
